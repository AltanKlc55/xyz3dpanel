...
const TableStickyHeaderBloglar = ({ data,handleClickFunc,openDuzenleModal }) => {
                  ...
                  {data.map((column,index) => {
                    return (
                      <TableRow key={index} hover role='checkbox' tabIndex={-1}>
                       ...
                       <TableCell >{column.img}</TableCell>
                       <TableCell >{column.date_time}</TableCell>
...
export default TableStickyHeaderBloglar;
