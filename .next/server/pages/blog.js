...
;// CONCATENATED MODULE: ./src/views/form-layouts/BloglarForm.js
...
const BloglarForm = ({ reDatas , closeModal  })=>{
    ...
    const onSubmit = async ()=>{
        ...
        const res = await fetch(`${"http://localhost:3000"}/api/blog`, postData);
...
/* harmony default export */ const form_layouts_BloglarForm = (BloglarForm);
...
;// CONCATENATED MODULE: ./src/views/form-layouts/BloglarDuzenleForm.js
...
const BloglarDuzenleForm = ({ dataUpdates , reDatas , closeModal  })=>{
    ...
    const { 0: nedenBizBasligi , 1: setNedenBizBasligi  } = (0,external_react_.useState)();
    const { 0: nedenBizContent , 1: setNedenBizContent  } = (0,external_react_.useState)();
...
/* harmony default export */ const form_layouts_BloglarDuzenleForm = (BloglarDuzenleForm);
...
const MUITable = ()=>{
    ...
    const handleClick = async (id)=>{
        ...
        const res = await fetch(`${"http://localhost:3000"}/api/blog`, deleteData);
        const response = await res.json();
        console.log(response);
        rastgeleSayiUret();
    };
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)((Grid_default()), {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx((Typography_default()), {
                        variant: "body2",
                        children: "Blogları ekleyip \xe7ıkartıp d\xfczenleyin.."
                    })
                ]
            }),
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)((Grid_default()), {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(material_.Box, {
                            ...
                            children: [
                                /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                                    ...
                                    children: "Blog D\xfczenle"
                                }),
                                /*#__PURE__*/ jsx_runtime_.jsx(form_layouts_BloglarDuzenleForm, {
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx((Modal_default()), {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(material_.Box, {
                            ...
                            children: [
                                /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                                    id: "child-modal-title",
                                    children: "Yeni Blog Ekle"
                                }),
                                /*#__PURE__*/ jsx_runtime_.jsx(form_layouts_BloglarForm, {
                                    reDatas: rastgeleSayiUret,
...
/* harmony default export */ const blog = (MUITable);
...
var __webpack_exports__ = __webpack_require__.X(0, [3598,5675,7990,4444], () => (__webpack_exec__(6785)));
