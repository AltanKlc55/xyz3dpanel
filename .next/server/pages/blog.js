...
const BloglarForm = ({ reDatas , closeModal  })=>{
    ...
    const onSubmit = async ()=>{
        ...
        const res = await fetch(`${"http://testpanel.pixwaragerncy.com/"}/api/blog`, postData);
...
const MUITable = ()=>{
    ...
    const handleClick = async (id)=>{
        ...
        const res = await fetch(`${"http://testpanel.pixwaragerncy.com/"}/api/blog`, deleteData);
        const response = await res.json();
...
var __webpack_exports__ = __webpack_require__.X(0, [3598,5675,7990,4444], () => (__webpack_exec__(5629)));
